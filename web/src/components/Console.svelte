...
<footer class="bg-gray-800 dark:bg-black">
  <div
    class="flex h-8 w-full items-center justify-between gap-2 border-b border-gray-800/50 bg-gray-900 p-2 dark:bg-gray-950"
  >
    ...
    {#each latestLogItems as log}
      {#if $settings.groupConsoleItems && log.type === "debug-group" && log.items.length > 1}
        <div class="group flex flex-col">
          ...
          >
            <span class="block whitespace-nowrap tabular-nums tracking-tight text-gray-400">
